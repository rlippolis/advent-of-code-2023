...
internal class Day13Test {
    ...
    private val example = Utils.readFile(day = 13, name = "example")
    private val input = Utils.readFile(day = 13, name = "input")
